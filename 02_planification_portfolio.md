...
Une expérience de réalité virtuelle immersive où l’utilisateur explore un environnement interactif.
...
Nous avons créé un univers dans lequel les gestes de l’utilisateur ont un effet sur son environnement. Nous avons combiné les interactions avec des animations, des déplacements et des sons afin de rendre la progression de l’expérience en réalité virtuelle immersive.
...
Description courte du projet (résumé en 1 phrase) :
Le Projet Paysage est une performance visuelle en temps réel où un paysage numérique se transforme au rythme du son et des interactions gestuelles et MIDI.
...
Description courte du projet (résumé en 1 phrase) :
Une installation immersive qui utilise la réalité virtuelle, une mosaïque vidéo, des effets sonores et des lumières afin de créer un récit multisensoriel.
...
Description courte du projet (résumé en 1 phrase) :
Le Projet Rouge est une mosaïque en stop motion et en animation 2D qui transforme des objets rouges en une composition abstraite inspirée du Bauhaus.
...
Réalisé dans le cadre du cours : Vidéo 2
Individuel ou en équipe : En équipe
Nom de vos coéquipiers : Marie-Lili Laprise, Emmanuel Ricard
...
Description courte du projet (résumé en 1 phrase) :
Une vidéo expérimentale sensorielle qui utilise les détails du corps, l’accumulation d’images et le son comme langage poétique, avec et sans paroles.
